-- Migration: Friends System Security Definer
-- Add SECURITY DEFINER to friend functions to bypass RLS for aggregate queries

-- Drop and recreate get_mutual_friends with SECURITY DEFINER
...
-- Drop and recreate are_friends with SECURITY DEFINER
...
-- Drop and recreate get_friend_count with SECURITY DEFINER
...
-- Drop and recreate get_friend_suggestions with SECURITY DEFINER
...
-- Drop and recreate get_friends_of_friends with SECURITY DEFINER
...
-- Drop and recreate get_recently_active_users with SECURITY DEFINER
...
-- Drop and recreate get_shelf_comparison with SECURITY DEFINER
...
-- Drop and recreate search_users with SECURITY DEFINER
